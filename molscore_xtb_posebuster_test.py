...
def main():
    ...
    molecules_smiles = [mol["smiles"] for mol in new_molecules]
    constraints_mol_scores = MolScore(model_name='test').score(molecules_smiles)

    molecules_rdkit = [mol["rdkit"] for mol in new_molecules]
    ...
    for mol in new_molecules:
        quantity_value = xtb_simulation.compute_true_reward(mol["dgl"], "dgl", "homolumo")
