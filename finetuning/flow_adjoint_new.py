...
#### TRAINER ####
class AdjointMatchingFinetuningTrainerFlowMolNew:
    def __init__(self,
            config: OmegaConf,
            model: flowmol.FlowMol,
        ...
        # Engineering tricks:
        self.iterations = self.sampling_config.num_samples // self.config.batch_size
    ...
    def finetune(self):
        ...
        for i in range(self.iterations):
            dataset, adj_0_norm = self.generate_dataset()
            loss, grad_norm = self.train_step(dataset[0])
        ...
        return total_loss / counter, total_grad_norm / counter, avg_adj_0_norm / counter
